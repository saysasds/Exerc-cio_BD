...
-- Started on 2018-07-14 21:56:28 -03
...
-- Name: cliente fk_endereço_cliente; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.cliente
    ADD CONSTRAINT "fk_endereço_cliente" FOREIGN KEY (endereco_cd_endereco) REFERENCES public.endereco(cd_endereco);
...
-- Completed on 2018-07-14 21:56:29 -03
